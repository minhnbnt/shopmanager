...
<html lang="en">
	<head>
		...
		<title>Bill Review Confirm - Shop Manager</title>

		<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/tailwind.css" />
		...
		<div class="m-10 flex w-fit flex-col-reverse gap-5">
			<div class="card w-full">
				<header class="flex flex-col">
					<h2>Confirm</h2>
					<p>Are you sure to approve the bill?</p>
				</header>

				<section
					class="grid overflow-x-auto lg:grid-cols-2 lg:gap-5 lg:space-y-0"
				>
							...
							<table id="customer-info-table" class="table">
								...
								<tbody>
									...
									<tr>
										...
										<td class="pr-3">${bill.customer.address}</td>
									</tr>
									<tr>
					...
					<div>
						<label
							for="delivery-staff-info-table"
							class="label col-span-2 mb-3"
						>
							Delivery staff info
						</label>
						<div class="overflow-hidden rounded-lg border">
							<table id="delivery-staff-info-table" class="table">
								<thead>
									<tr>
										<th class="pl-3">Field</th>
										<th>Value</th>
								...
								<tbody>
									...
									<tr>
										<td class="pl-3">Full name</td>
										<td>${deliveryStaff.fullName}</td>
									</tr>
									<tr>
										<td class="pl-3">Số điện thoại</td>
										<td>${deliveryStaff.phoneNumber}</td>
									</tr>
									<tr>
				...
				<section class="flex justify-end gap-3">
					...
					<form action="${pageContext.request.contextPath}/saleAgent/billReview" method="post" class="inline">
						...
						<input type="hidden" name="deliveryStaffId" value="${deliveryStaff.id}" />
			...
			<div class="card flex-row items-center justify-between p-2">
				...
				>
					...
					<li class="inline-flex items-center gap-1.5">
						<span class="text-foreground font-normal">Confirm Assignment</span>
					</li>
				</ol>
